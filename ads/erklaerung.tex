...
Zudem erkläre ich, dass ich bei der Erstellung dieser Arbeit Künstliche Intelligenz (Gemini und Perplexity) als methodisches Hilfsmittel herangezogen habe. Die Nutzung umfasste konkrete Unterstützung bei der technischen LaTeX-Formatierung, der Textstrukturierung, der sprachlichen Überarbeitung und Fehlerkorrektur sowie das interaktive Brainstorming als \enquote{Sparringspartner} in der Vorbereitungsphase.

Ich versichere ausdrücklich, dass die inhaltliche Konzeption des Testdesigns, die wissenschaftliche Argumentation sowie die gesamte analytische und kritische Auswertung der Ergebnisse vollständig meiner eigenen geistigen Leistung entspringen.
}
